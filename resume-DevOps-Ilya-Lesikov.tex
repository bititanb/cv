...
\titlespacing*{\subsection}{0.7em}{1.3ex}{0ex}
...
%test test2 \hskip 4cm minus 4cm test3 \hskip 4cm test4 
\begin{spacing}{0.3}
\begin{etaremune}
\item
...
\end{etaremune}
\end{spacing}
%% TODO: do without itemize lists (no need for them); try something like \hfill instead of tables???
\begin{spacing}{0.3}
