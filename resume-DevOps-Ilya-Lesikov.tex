...
{\setlength\multicolsep{0pt}\begin{multicols}{2}
  ...
  \begin{flushright}\begin{spacing}{1.3}\rmfamily
    \textit{Updated: 21/02/2020}\\[0.5ex]
    \large{
...
\forceindent I'm an experienced Automation Developer/DevOps/SRE, who loves development, but still has a strong Linux SysAdmin background.
...
\newpage
  ...
  \item
    ...
    \forceindent Why left: no professional and/or career advancement.
